      ...
      <ul class="space-y-2 font-medium">
         ...
         <li><Link to="/link">
            <a class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">LinkTree</span>
...
<footer class="p-4 sm:ml-64 bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="#landing" class="flex items-center">
                  <img src={vinkev} class="h-8 me-3" alt="FlowBite Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Vinkev Craft</span>
              </a>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://github.com/SkulZOnTheYT" class="hover:underline">SK Store™</a> All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="https://github.com/SkulZOnTheYT" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
